...
public class ExampleKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ExampleKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ExampleKafkaResource(KafkaProperties kafkaProperties) {
